...
public class InternetService extends Service implements Runnable {
    ...
    private void connectService() {
        try {
            socket = new Socket();
            SocketAddress socAddress = new InetSocketAddress("127.0.0", 8000);
            ...
            ex.printStackTrace();
            workStatus = "Constant.TAG_FAILURE";// 如果是网络连接出错了，则提示网络连接错误
            return;
    ...
    private boolean isNetworkConnected() {
        final ConnectivityManager connManager = (ConnectivityManager) getApplicationContext()
    ...
    public void run() {
        try {
            ...
            workStatus = "Constant.TAG_FAILURE";// 如果出现异常，提示网络连接出现问题。
            ex.printStackTrace();
        }
    }
